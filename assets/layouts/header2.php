      ...
      <nav class="nav-menu float-left d-none d-lg-block">
        <ul>
          ...
          ?>
            ...
            <li><a href="blogs.php#container#container">Blogs</a></li>
            <li><a href="profile.php#container">Profile</a></li>
            <li><a href="logout.php">Logout</a></li>
          <?php
            }elseif ($page == 'about') {
          ?>
            <li><a href="index.php">Home</a></li>
            <li class="active"><a href="about.php#container">About Us</a></li>
            <li><a href="market.php#container">Market</a></li>
            <li><a href="contact.php#container">Contact</a></li>
            <li><a href="faq.php#container">FAQ</a></li>
          ...
          ?>
            ...
            <li><a href="faq.php#container">FAQ</a></li>
            <li><a href="blogs.php#container">Blogs</a></li>
            <li class="active"><a href="profile.php#container">Profile</a></li>
            <li><a href="logout.php">Logout</a></li>
          <?php
            }
          ?>
